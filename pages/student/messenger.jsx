    ...
    <div className="flex flex-row h-full w-full overflow-x-hidden">
      <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        ...
        <div className="flex flex-row items-center justify-center h-12 w-full">
          <div
            className="flex items-center justify-center rounded-2xl text-red-700 bg-red-100 h-10 w-10"
          >
            <svg
              className="w-6 h-6"
              fill="none"
        ...
        >
          ...
          <div className="flex flex-row items-center mt-3">
            <div
              className="flex flex-col justify-center h-4 w-8 bg-red-500 rounded-full"
            >
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
            ...
            >
              <div
                className="flex items-center justify-center h-8 w-8 bg-red-200 rounded-full"
              >
                H
              </div>
              ...
              <div className="grid grid-cols-12 gap-y-2">
                <div className="col-start-1 col-end-8 p-3 rounded-lg">
                  <div className="flex flex-row items-center">
                    <div
                      className="flex items-center justify-center h-10 w-10 rounded-full bg-re-500 flex-shrink-0"
                    >
                      A
                    </div>
                    <div
